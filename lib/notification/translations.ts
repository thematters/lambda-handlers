...
export default {
  ...
  write_challenge_applied: i18n({
    zh_hant: `你已成功報名三日書，點此閱讀公告查看詳情，了解如何發文、完成七天寫作`,
    zh_hans: `你已成功报名三日书，点此阅读公告查看详情，了解如何发文、完成七天写作`,
  ...
  write_challenge_applied_late_bird: i18n({
    zh_hant: `歡迎晚鳥參與三日書，點此閱讀公告查看詳情，了解如何發文、完成七天寫作`,
    zh_hans: `欢迎晚鸟参与三日书，点此阅读公告查看详情，了解如何发文、完成七天写作`,
